...
In this tutorial, I am going to show you how to develop a page using a *mobile-first, responsive design* using Bootstrap. I will assume you have already followed the previous [responsive design tutorial](https://github.com/BYU-CS-260/responsive-design) and will focus on using the [Bootstrap](https://getbootstrap.com) framework. You could follow a similar path using other frameworks, such as [Pure.css](https://purecss.io).
